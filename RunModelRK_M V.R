...
# name outputs
out.model <- "modelF_tObs_atMR_noYAF.rds"
out.sum <- "modelF_tObs_atMR_noYAF_sum.txt"
...
myCode <- nimbleCode({
  ...
  # mu.phi[1] ~ dbeta(4, 4) # if 1 is YAF
  mu.phi[1] ~ dbeta(8, 2)   # if 1 is 1 year-old subadults
